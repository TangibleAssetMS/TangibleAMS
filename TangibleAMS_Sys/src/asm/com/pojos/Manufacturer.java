...
public class Manufacturer {
	...
	public Manufacturer(String manuFacturerName, String webSiteLink,
			String contactName, Integer phone, String address, String city,
			String email, Integer fax, String description, Set<Asset> asset,
			Set<Invoice> invoice) {
		super();
